...
const Features = () => {
  return (
    <div className="bg-[#151b25] pb-[7px]">
      <div className=" px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
          <div className="lg:w-1/2">
            <h2 className="max-w-md mb-6 font-sans text-3xl font-bold tracking-tight text-gray-100 sm:text-4xl sm:leading-none xl:max-w-lg">
        ...
        <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5  text-blue-400">
              Our planet
            </h6>
            ...
            <ul className="mb-4 -ml-1 space-y-2  text-gray-200">
            ...
            <a
              href="/"
              aria-label=""
              className="  text-blue-600 inline-flex items-center font-semibold transition-colors duration-200 text-deep-purple-accent-400 hover:text-deep-purple-800"
            >
              Learn more
            </a>
          </div>
