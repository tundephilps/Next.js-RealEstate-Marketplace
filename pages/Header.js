  ...
  return (
    <div>
      ...
      <main id="content" role="main">
        <nav
          className="sticky -top-px  text-sm font-medium text-black ring-1 ring-gray-900 ring-opacity-5 border-t shadow-sm shadow-gray-100 pt-6 md:pb-6 -mt-px bg-[#151b25] border-gray-800 dark:shadow-slate-700/[.7]"
          aria-label="Jump links"
        >
          <div className="max-w-7xl snap-x w-full flex items-center overflow-x-hidden scrollbar-x px-4 sm:px-6 lg:px-8 pb-4 md:pb-0 mx-auto dark:scrollbar-x">
            <Link
              href="/Homepage"
